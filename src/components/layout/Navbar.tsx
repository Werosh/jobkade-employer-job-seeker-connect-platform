      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center">
            <span className="text-xl font-bold">JobKade</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/jobs/find" className="hover:text-blue-200 transition-colors">
              Find Jobs
            </Link>
            <Link href="/dashboard/post-job" className="hover:text-blue-200 transition-colors">
              Post Jobs
            </Link>
